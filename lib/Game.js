    ...
    initializeGame() {
        ...
        inquirer
            ...
            .then(({ name }) => {
                ...
                console.log(`${chalk.blue('It was the best of times, it was the worst of times, it was the age of wisdom, it was the age of foolishness, it was the epoch of belief, it was the epoch of incredulity, it was the season of Light🌕, it was the season of Darkness🌑, it was the spring of hope, it was the winter of despair, we had everything before us, we had nothing before us, we were all going direct to Heaven, we were all going direct the other way...')}`)
    ...
    checkEndOfBattle() {
        ...
        // executes if player is alive but enemy is dead
            ...
            if (this.battleNumber < this.enemies.length) {
                ...
                console.log(`${chalk.blue(`You win! ${this.player.getName()} has successfully tamed all the suffering creatures in your dungeon. The purified creatures awake and shine brightly, becoming your mythical pets. You meet others who have overcome their challenges. Together on a path of Light towards a new world will you maintain in Light, or surrender to the season of Darkness..\n`)}`);
                process.exit(); 
            }
        }
